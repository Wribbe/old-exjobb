...
HOOK_TIMEW=$DIR_HOOKS/on-modifytimewarrior

DIR_CALENDAR_CACHE=$ROOT/calendar
...
export DIR_LOCAL_CALENDAR_CACHE=$DIR_CALENDAR_CACHE
...
# Check if there is a dir for Calendar.
[ -d $DIR_CALENDAR_CACHE ] || mkdir $DIR_CALENDAR_CACHE

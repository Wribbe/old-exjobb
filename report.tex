...
\section{Methodology}
  ...
  \cite{c_product_shotgun}
  \cite{c_stress_nurses_article_occupational_job_performance}
...
\section{References}
  ...
  \cite{c_stress_techno_article_antecedents_and_implications}
  \cite{c_gamedev_project_work_article_possible_mobilization}
